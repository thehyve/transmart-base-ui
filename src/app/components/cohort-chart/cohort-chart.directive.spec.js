...
describe('Unit testing cohort-chart directive', function () {
    ...
    describe('exportImage', function () {
        it('should export png when image type is png', function () {
            spyOn(CohortExportService, 'exportChartPNG');
            var _scope = chartElm.isolateScope();
            _scope.exportImage({}, 'png');
            expect(CohortExportService.exportChartPNG).toHaveBeenCalled();
        });

        it('should export pdf when image type is pdf', function () {
            spyOn(CohortExportService, 'exportChartPDF');
            var _scope = chartElm.isolateScope();
            _scope.exportImage({}, 'pdf');
            expect(CohortExportService.exportChartPDF).toHaveBeenCalled();
        });

        it('should export svg when image type is svg', function () {
            spyOn(CohortExportService, 'exportChartSVG');
            var _scope = chartElm.isolateScope();
            _scope.exportImage({}, 'svg');
            expect(CohortExportService.exportChartSVG).toHaveBeenCalled();
        });

        it('should export png as default', function () {
            spyOn(CohortExportService, 'exportChartPNG');
            var _scope = chartElm.isolateScope();
            _scope.exportImage({}, 'wrong format');
            expect(CohortExportService.exportChartPNG).toHaveBeenCalled();
        });
